    ...
    <div v-cloak>
        ...
        <div class="card mt-2">
            ...
            <b-collapse v-model="toggles.information">
                <!--not archived-->
                <div v-if="item.status===1 || item.status===2 || item.status===4" class="p-1 text-right">
                    <div class="dropdown ">
                ...
                <div class="p-2">
                    <div class="form-row">
                        <div class="form-group col-md">
                            <label>Name</label>
                            <div class="form-control-plaintext">
                                <b-avatar :src="item.customer.urlProfilePicture"></b-avatar>
                                {{item.customer.name}}
                            </div>
                        </div>
                ...
                <div class="p-2">
                    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4">
                        <div v-for="imageUrl in item.fileUploadUrls" class="col">
                            ...
                            <a :href="imageUrl" target="_blank" rel="noopener noreferrer" class="btn btn-outline-info">
